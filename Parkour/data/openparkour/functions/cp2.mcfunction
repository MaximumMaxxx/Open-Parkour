...
execute if score @p Saved matches 1 if score @p Checkpoint matches 1 run tellraw @p {"text":"Checkpoint!","color":"gold"}
execute if score @p Saved matches 1 if score @p Checkpoint matches 1 run scoreboard players add @p Checkpoint 1
