...
execute if score @p Saved matches 1 if score @p Checkpoint matches 0 run tellraw @p {"text":"Checkpoint!","color":"gold"}
execute if score @p Saved matches 1 if score @p Checkpoint matches 0 run scoreboard players add @p Checkpoint 1
