...
execute if score @p Saved = 0 NumberStorage if score @p LeaderBoardSecs = 0 NumberStorage run function max:save
execute if score @p Saved = 0 NumberStorage run execute if score @p LeaderBoardSecs > 0 NumberStorage run execute if score Seconds PlayerTiming < @p LeaderBoardSecs run function max:save
execute if score @p Saved = 0 NumberStorage run execute if score @p LeaderBoardSecs > 0 NumberStorage run execute if score Seconds PlayerTiming < @p LeaderBoardSecs run execute if score Ticks PlayerTiming < @p LeaderBoardTicks run function max:save
